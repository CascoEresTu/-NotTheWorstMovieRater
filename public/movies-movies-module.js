...
var MovieService = /** @class */ (function () {
    ...
    MovieService.prototype.post = function (data) {
...
module.exports = "<div class=\"containter\">\r\n  <div class=\"row\">\r\n    <div class=\"col-sm-12\">\r\n      <button class=\"btn btn-primary pull-right\" (click)=\"openModalAdd(add)\" >Add</button>\r\n      <table class=\"table table-hover\">\r\n        <thead>\r\n          <tr>\r\n            <th>Name</th>\r\n            <th>Year</th>\r\n            <th>poster</th>\r\n            <th>Rating</th>\r\n          </tr>\r\n        </thead>\r\n        <tbody>\r\n          <tr>\r\n            <tr *ngFor= \"let movie of movies\">\r\n              <td>{{movie.name}}</td>\r\n              <td>{{movie.year}}</td>\r\n              <td>{{movie.poster}}</td>\r\n            \r\n            <td>\r\n              <button class=\"btn btn-warning\">Edit</button> |\r\n              <button class=\"btn btn-danger\">Delete</button>\r\n            </td>\r\n          </tr>\r\n        </tbody>\r\n      </table>\r\n    </div>\r\n  </div>\r\n</div>\r\n\r\n\r\n\r\n<ng-template #add>\r\n  <div class=\"modal-header\">\r\n    <h4 class=\"modal-title pull-left\">Modal</h4>\r\n    <button type=\"button\" class=\"close pull-right\" aria-label=\"Close\" (click)=\"modalRef.hide()\">\r\n      <span aria-hidden=\"true\">&times;</span>\r\n    </button>\r\n  </div>\r\n  <div class=\"modal-body\">\r\n    <form>\r\n      <label for= \"name\" >Movie Name</label>\r\n      <input type=\"text\" class= \"form-control\" name= \"name\" [(ngModel)]=\"movie.name\">\r\n      <p class=\"text-danger\">{{errorMsg.name}}</p>\r\n\r\n      <label for= \"year\" >Release Year</label>\r\n      <input type=\"number\" class= \"form-control\" name= \"year\" [(ngModel)]=\"movie.year\">\r\n      <p class=\"text-danger\">{{errorMsg.year}}</p>\r\n\r\n      <label for= \"poster\" >Movie Poster</label>\r\n      <input type=\"text\" class= \"form-control\" name= \"poster\" [(ngModel)]=\"movie.poster\">\r\n      <p class=\"text-danger\">{{errorMsg.poster}}</p>\r\n\r\n\r\n      <button class=\"btn btn-primary\" (click)=\"onSave()\" >Save</button>\r\n\r\n    </form>\r\n  </div>\r\n</ng-template>"
...
var MovieListComponent = /** @class */ (function () {
    function MovieListComponent(modalService, movieService) {
    ...
    MovieListComponent.prototype.getMovie = function () {
        var _this = this;
        this.movieService.get().subscribe(function (res) {
            _this.movies = res;
    ...
    MovieListComponent.prototype.onSave = function () {
        var _this = this;
        ...
        this.movieService.post(this.movie).subscribe(function (res) {
            _this.getMovie();
            _this.modalRef.hide();
            console.log(res);
        }, function (error) {
    ...
    MovieListComponent.prototype.openModalAdd = function (template) {
    ...
    MovieListComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [ngx_bootstrap_modal__WEBPACK_IMPORTED_MODULE_2__["BsModalService"], _movie_service__WEBPACK_IMPORTED_MODULE_3__["MovieService"]])
    ], MovieListComponent);
...
/* harmony import */ var _movie_list_movie_list_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./movie-list/movie-list.component */ "./src/app/movies/movie-list/movie-list.component.ts");
/* harmony import */ var ngx_bootstrap_modal__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ngx-bootstrap/modal */ "./node_modules/ngx-bootstrap/modal/fesm5/ngx-bootstrap-modal.js");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm5/forms.js");
/* harmony import */ var angular_star_rating__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! angular-star-rating */ "./node_modules/angular-star-rating/esm5/angular-star-rating.js");
...
var MoviesModule = /** @class */ (function () {
    ...
    MoviesModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [_movie_list_movie_list_component__WEBPACK_IMPORTED_MODULE_4__["MovieListComponent"]],
            imports: [
